<form method="POST" id="editstudentsForm" action="{{ url('api/v1/students/update/' . request()->id ?? '') }}"
        ...
        <div class="mb-3 col-12 col-md-4 col-lg-3">
            <div class="form-group">
                ...
                <input type="number" name="roll" min="0"
                    ...
                    value="{{ old('roll', $query->roll ?? '') }}" placeholder="Enter Roll..." id="edit_roll" required>
                @error('roll')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
